...
public class AdopetConsoleApplication {
    ...
    private static void listarAbrigos() throws IOException, InterruptedException {
        ...
        HttpResponse<String> response = dispararRequisiçãoGet(client, uri);
    ...
    private static HttpResponse<String> dispararRequisiçãoGet(HttpClient client, String uri) throws IOException, InterruptedException {
