...
public class MedicoController {
    ...
    public ResponseEntity<Page<DadosListagemMedico>> listar(@PageableDefault(size = 10, sort = {"nome"}) Pageable paginacao) {
        //return repository.findAll(paginacao).map(DadosListagemMedico::new); //Nesse caso está retornando todos os médicos cadastrados
    ...
    public ResponseEntity excluir(@PathVariable Long id) {
        //repository.deleteById(id); //esse metodo faz a exclusão completa do banco
