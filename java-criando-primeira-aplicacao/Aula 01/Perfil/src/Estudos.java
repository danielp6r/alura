public class Estudos {
    public static void main(String[] args) {
        ...
        System.out.println("- Revisar conceitos de Java.");
        System.out.println("- Praticar POO e coleções.");
        System.out.println("- Estudar SQL e banco de dados.");
        System.out.println("- Criar projetos para o portfólio.");
